...
require_once(FS_CERTIFICATION_FUNCTIONS."/functions.php");
	...
	function main() {
		pb_system_log("List","Companies",$id);
		global $db; //created parameter to be used on line 61
		global $s_identikey;
		global $s_username;
?>
<div class="m-heading-1 border-green m-bordered">
	...
	<p>
	If a company that you do business with has granted you permission to access their data, you can view it in this section.
	</p>
	...
	<div class="table">
		<table class="table table-striped table-bordered table-advance table-hover">
			<thead>
				<tr>
					<th>
						<i class="fa fa-briefcase"></i> Company name </th>
					<th class="hidden-xs">
						<i class="fa fa-star-o"></i> Rating </th>
					<th>
						<i class="fa fa-database"></i> Access Status </th>
					<th> </th>
				</tr>
			</thead>
			...
			$statement = $db->prepare("select * from certification_record where identikey='ddd$s_identikey' and object_status='active'");
			$statement->execute();
			...
			<tr id="" >
				<td colspan="4" align="center">
					You do not currently have access to any other company's data.
				</td>
			</tr>
