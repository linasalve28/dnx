...
?>
  <div class="m-heading-1 border-green m-bordered">
    <h3>Assessment Requests</h3>
    <p>Below are assessment requests that you have sent
    </p>
  </div>
...
<div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-purple-soft bold uppercase">Requests</span>
                                    </div>
                                ...
                                <div class="portlet-body">
                                    <ul class="nav nav-tabs">
                                        <li class="nav-item">
                                            <a href="#tab_1_1" data-toggle="tab" aria-expanded="true" class="nav-link active"> Requests Sent </a>
                                        </li>
                                        <li class="">
                                            <a href="#tab_1_2" data-toggle="tab" aria-expanded="true"  class="nav-link"> Request Received </a>
                                        </li>
                                        
                                    </ul>
                                    <div class="tab-content">
                                        <div class="tab-pane fade active in" id="tab_1_1">   
                                     <?php display_request_list("sent"); ?>
                                       
                                        </div>
                                        <div class="tab-pane fade" id="tab_1_2">
	                                   <?php display_request_list("received"); ?>
