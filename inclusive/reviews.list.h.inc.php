...
require_once(FS_DTA_FUNCTIONS."/functions.php");

  function main() {
	  	pb_system_log("List","Reviews",$id);
global $s_identikey;
global $s_username;
    ?>
  <div class="m-heading-1 border-green m-bordered">
    <h3>Reviews</h3>
    <p>
	    Reviews are submitted by clients and provide feedback on your company's performance.
    </p>
                                      ...
                                      <div class="table">
                                          <table class="table table-striped table-bordered table-advance table-hover">
                                              <thead>
                                                  <tr>
                                                      <th>
                                                          <i class="fa fa-angle-right"></i> ID </th>
                                                      <th class="hidden-xs">
                                                          <i class="fa fa-calendar"></i> Date</th>
                                                      <th>
                                                          <i class="fa fa-star-half-o"></i>  Rating </th>
                                                      <th> </th>
                                                  </tr>
                                              </thead>
...
<tr id="" >
                                                      <td colspan="4" align="center">
	                                                     There are currently no reviews of your company.
                                                      </td>
</tr>
